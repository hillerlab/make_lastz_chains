#!/usr/bin/env python3
"""Python replacement for chainIndexID
...
if __name__ == "__main__":
    try:  # read args
        in_chain_arg = sys.argv[1]  # in.chain
        index_file_arg = sys.argv[2]  # 
    except IndexError:  # if args are wrong: show usage and quit
        sys.stderr.write("Recommended file extension for index file is bb.\n")
        sys.exit(f"Usage: {sys.argv[0]} [in.chain] [output.bb]\n")
